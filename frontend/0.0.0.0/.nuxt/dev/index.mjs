...
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///opt/app/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///opt/app/node_modules/devalue/index.js';
import destr from 'file:///opt/app/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL } from 'file:///opt/app/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///opt/app/node_modules/vue/server-renderer/index.mjs';
import { hash } from 'file:///opt/app/node_modules/ohash/dist/index.mjs';
import { propsToString, renderSSRHead } from 'file:///opt/app/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///opt/app/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///opt/app/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///opt/app/node_modules/hookable/dist/index.mjs';
import { klona } from 'file:///opt/app/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file:///opt/app/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file:///opt/app/node_modules/defu/dist/defu.mjs';
import { createStorage, prefixStorage } from 'file:///opt/app/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///opt/app/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///opt/app/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file:///opt/app/node_modules/consola/dist/index.mjs';
import { getContext } from 'file:///opt/app/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///opt/app/node_modules/errx/dist/index.js';
import { isVNode, version, unref } from 'file:///opt/app/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file:///opt/app/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///opt/app/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/opt/app/0.0.0.0/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/opt/app/0.0.0.0","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/opt/app/0.0.0.0/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/opt/app/0.0.0.0/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/opt/app/0.0.0.0/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/opt/app/0.0.0.0/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _wE7XU58Lcy = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/opt/app/0.0.0.0";
...
const _lazy_eP6nDw = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_eP6nDw, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_eP6nDw, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file:///opt/app/0.0.0.0/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///opt/app/0.0.0.0/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
