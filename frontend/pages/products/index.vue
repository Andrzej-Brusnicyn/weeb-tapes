...
<template>
  <div class="bg-[#D7CEBD]">
    ...
    <form class="flex items-center max-w-sm mx-auto my-20" @submit.prevent="filteredProducts">
      ...
      <div class="relative w-full">
        ...
        <input type="text" id="simple-search" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search branch name..." v-model="searchQuery" required />
      </div>
    </form>

    <div class="flex justify-center">

      <div v-for="genre in genreArray">
