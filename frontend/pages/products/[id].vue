<script setup>
  ...
  const uri = 'http://api.weeb-tapes.de/api/v1/tapes/' + id
  console.log(uri)
  ...
  <div class="font-sans">
    <div class="p-4 lg:max-w-7xl max-w-xl max-lg:mx-auto">
      <div class="grid items-start grid-cols-1 lg:grid-cols-5 gap-12">
        <div class="min-h-[500px] lg:col-span-3 bg-gradient-to-b from-sky-50 to-cyan-200 rounded-lg w-full lg:sticky top-0 text-center p-6">
          <img :src="`${product.url}`" alt="Product" class="w-3/5 rounded object-cover mx-auto py-6" />
        </div>

        <div class="lg:col-span-2">
          <h2 class="text-2xl font-bold text-gray-800">{{product.title}} | {{product.artist}}</h2>
          <div class="flex flex-wrap flex-col gap-4 mt-4">
            <p class="text-gray-800 text-xl font-bold">${{product.price}}</p>
            <p class="text-gray-500 text-sm"><span>{{product.stock}}</span> <span class="text-sm ml-1">In stock</span></p>
          </div>
          ...
          <div class="flex space-x-2 mt-4">
            ...
            <svg class="w-5 fill-gray-400" viewBox="0 0 14 13" fill="none"
                 xmlns="http://www.w3.org/2000/svg">
              <path
                  d="M7 0L9.4687 3.60213L13.6574 4.83688L10.9944 8.29787L11.1145 12.6631L7 11.2L2.8855 12.6631L3.00556 8.29787L0.342604 4.83688L4.5313 3.60213L7 0Z" />
            </svg>
          ...
          <div class="mt-8">
            <h3 class="text-xl font-bold text-gray-800">About the music tape</h3>
            <div class="space-y-3 mt-4 pl-4 text-sm text-gray-800">
              {{product.description}}
            </div>
          </div>
            ...
            <div class="flex items-start mt-8">
              ...
              <div class="ml-3">
                ...
                <div class="flex space-x-1 mt-1">
                  ...
                  <svg class="w-4 fill-gray-400" viewBox="0 0 14 13" fill="none"
                       xmlns="http://www.w3.org/2000/svg">
                    <path
                        d="M7 0L9.4687 3.60213L13.6574 4.83688L10.9944 8.29787L11.1145 12.6631L7 11.2L2.8855 12.6631L3.00556 8.29787L0.342604 4.83688L4.5313 3.60213L7 0Z" />
                  </svg>
                ...
                <p class="text-xs mt-4">I like this stuff!!!</p>
              </div>
            </div>
            <button type="button" class="w-full mt-8 px-4 py-2.5 bg-transparent border border-blue-600 text-gray-800 font-semibold rounded-lg">Read all reviews</button>
          </div>
        </div>
      </div>
    </div>
